...
proc create_root_design { parentCell clock_id} {
  ...
  # Create instance: kernel_rtl, and set properties
  set kernel_rtl [create_bd_cell -type ip -vlnv xilinx.com:RTLKernel:XilinxShell:1.0 kernel_rtl]
  ...
  set_property -dict [ list \
    ...
    CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ {138} \
  ...
  connect_bd_intf_net -intf_net axi_interconnect_1_M00_AXI \
    ...
    [get_bd_intf_pins kernel_rtl/s_axi_control]
  ...
  connect_bd_intf_net -intf_net kernel_rtl_m_axi_gmem \
    ...
    [get_bd_intf_pins kernel_rtl/m_axi_gmem]
  ...
  connect_bd_net -net reset_net \
    ...
    [get_bd_pins kernel_rtl/ap_rst_n] \
  ...
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 \
    [get_bd_addr_spaces kernel_rtl/m_axi_gmem] \
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 \
    ...
    [get_bd_addr_segs kernel_rtl/s_axi_control/reg0] SEG_kernel_rtl_reg0
